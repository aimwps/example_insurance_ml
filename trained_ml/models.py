...
class ModelInference(models.Model):
    ...
    rf_age = models.PositiveIntegerField(blank=True, null=True)
    rf_gender = models.CharField(max_length=255, choices=gender_choices, blank=True, null=True)
    rf_bmi = models.DecimalField(max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), ], blank=True, null=True )
    rf_children = models.PositiveIntegerField(blank=True, null=True)
    rf_is_smoker = models.BooleanField(blank=True, null=True)
    rf_region = models.CharField(max_length=255, choices=region_choices, blank=True, null=True)
